...
class TextDataset(Dataset):
    ...
    def __getitem__(self, i):       
        return torch.tensor(self.examples[i].input_ids), torch.tensor(self.examples[i].repair_input_ids),  torch.tensor(self.examples[i].input_ids).ne(1), torch.tensor(self.examples[i].repair_input_ids).ne(1)
