...
class Seq2Seq(nn.Module):
    ...
    """
    def __init__(self, encoder,decoder,tokenizer,config,beam_size=None,max_length=None,sos_id=None,eos_id=None):
    ...
    def forward(self, source_ids=None,source_mask=None,target_ids=None,target_mask=None,args=None):   
        ...
        if target_ids is not None:  
            ...
            active_loss = target_mask[..., 1:].eq(self.tokenizer.pad_token_id).view(-1)
